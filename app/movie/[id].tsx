    ...
    <View className='bg-primary flex-1'>
     ...
     >
      <View>
        ...
        resizeMode='stretch'
        />
        <TouchableOpacity className="absolute bottom-5 right-5 rounded-full size-10 bg-white flex items-center justify-center">
            <Image
              source={icons.play}
      ...
      <TouchableOpacity
        className="absolute bottom-5 left-0 right-0 mx-5 my-7 bg-accent rounded-lg py-3.5 flex flex-row items-center justify-center z-50"
        onPress={router.back}
      >
        <Image
          source={icons.arrow}
